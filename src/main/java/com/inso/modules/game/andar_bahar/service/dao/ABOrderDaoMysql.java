...
@Repository
public class ABOrderDaoMysql extends DaoSupport implements ABOrderDao {

    private static final String TABLE = "inso_game_andar_bahar_order";

    public void addOrder(String orderno, String issue, ABType lotteryType, UserInfo userInfo, UserAttr userAttr, ABBetItemType betItem, OrderTxStatus txStatus, BigDecimal basicAmount, long betCount, BigDecimal totalBetAmount, BigDecimal feemoney, JSONObject remark)
    {
        ...
        keyvalue.put("order_bet_item", betItem.getKey());
    ...
    public void updateTxStatus(String orderno, OrderTxStatus txStatus, ABBetItemType openResult, BigDecimal winmoney, BigDecimal feemoney, JSONObject remark)
    {
        ...
        if(openResult != null)
        {
            setKeyValue.put("order_open_result", openResult.getKey());
        }
        if(remark != null && !remark.isEmpty())
        {
    ...
    public ABOrderInfo findByNo(String orderno)
    {
        ...
        return mSlaveJdbcService.queryForObject(sql, ABOrderInfo.class, orderno);
    }
    ...
    public List<ABOrderInfo> queryListByUserid(String createtime, long userid, int limit)
    {
        ...
        return mSlaveJdbcService.queryForList(sql, ABOrderInfo.class, createtime, userid);
    }

    public void queryAllByIssue(String issue, Callback<ABOrderInfo> callback)
    {
        String sql = "select * from " + TABLE + " where order_issue = ?";
        mSlaveJdbcService.queryAll(callback, sql, ABOrderInfo.class, issue);
    }
    ...
    public RowPager<ABOrderInfo> queryScrollPage(PageVo pageVo, ABType lotteryType, long userid, long agentid,long staffid, String systemNo, String issue, OrderTxStatus txStatus,String sortName,String sortOrder)
    {
        ...
        String countsql = "select count(1) from inso_game_andar_bahar_order as A " + whereSQL;
        ...
        StringBuilder select = new StringBuilder("select A.*,B.attr_direct_staffname as order_staffname ,C.money_balance as order_balance,C.money_total_recharge as order_total_recharge,(C.money_total_withdraw-C.money_total_refund) as order_total_withdraw  from inso_game_andar_bahar_order as A ");
        ...
        List<ABOrderInfo> list = mSlaveJdbcService.queryForList(select.toString(), ABOrderInfo.class, values.toArray());
        RowPager<ABOrderInfo> rowPage = new RowPager<>(total, list);
        return rowPage;
    }
    ...
    public void queryAllMember(String startTimeString, String endTimeString, Callback<ABOrderInfo> callback)
    {
        ...
        mSlaveJdbcService.queryAll(callback, sql, ABOrderInfo.class, startTimeString, endTimeString);
    }
