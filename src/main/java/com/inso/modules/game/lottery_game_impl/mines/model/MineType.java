package com.inso.modules.game.lottery_game_impl.mines.model;
...
public enum MineType implements GameChildType {

    Mines("Mines", "Mines",1, 0, 0), // 1分钟
    ;

    public static final MineType[] mArr = MineType.values();
     ...
     * @param key
     */
    MineType(String key, String title, int code, int totalSeconds, int disableSecond)
    {
        this.key = key;
        this.title = title;
    ...
    public static MineType getType(String key)
    {
        for(MineType type : mArr)
        {
