...
@Repository
public class FruitOrderDaoMysql extends DaoSupport implements FruitOrderDao{

    private static final String TABLE = "inso_game_fruit_order";
    ...
    public FruitOrderInfo findByNo(String orderno)
    {
        ...
        return mSlaveJdbcService.queryForObject(sql, FruitOrderInfo.class, orderno);
    }
    ...
    public List<FruitOrderInfo> queryListByUserid(String createtime, long userid, int limit)
    {
        ...
        return mSlaveJdbcService.queryForList(sql, FruitOrderInfo.class, createtime, userid);
    }

    public void queryAllByIssue(String issue, Callback<FruitOrderInfo> callback)
    {
        String sql = "select * from " + TABLE + " where order_issue = ?";
        mSlaveJdbcService.queryAll(callback, sql, FruitOrderInfo.class, issue);
    }
    ...
    public RowPager<FruitOrderInfo> queryScrollPage(PageVo pageVo, FruitType lotteryType, long userid, long agentid,long staffid, String systemNo, String issue, OrderTxStatus txStatus)
    {
        ...
        String countsql = "select count(1) from inso_game_fruit_order as A " + whereSQL;
        ...
        StringBuilder select = new StringBuilder("select  A.*, B.attr_direct_staffname as order_staffname ,C.money_balance as order_balance,C.money_total_recharge as order_total_recharge,(C.money_total_withdraw-C.money_total_refund) as order_total_withdraw  from inso_game_fruit_order as A ");
        ...
        List<FruitOrderInfo> list = mSlaveJdbcService.queryForList(select.toString(), FruitOrderInfo.class, values.toArray());
        RowPager<FruitOrderInfo> rowPage = new RowPager<>(total, list);
        return rowPage;
    }
    ...
    public void queryAllMember(String startTimeString, String endTimeString, Callback<FruitOrderInfo> callback)
    {
        ...
        mSlaveJdbcService.queryAll(callback, sql, FruitOrderInfo.class, startTimeString, endTimeString);
    }
