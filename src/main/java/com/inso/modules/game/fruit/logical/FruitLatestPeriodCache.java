 ...
 * 历史开奖缓存，只缓存最新几期
 */
public class FruitLatestPeriodCache {
    ...
    private static final String CACHE_KEY = MyConstants.DEFAULT_GAME_MODULE_NAME + FruitLatestPeriodCache.class.getName();

    public static void updateCache(FruitType lotteryType, List<FruitPeriodInfo> rsList)
    {
        ...
        for(FruitPeriodInfo tmp : rsList)
        {
...
//            model.put(KEY_END_TIME, tmp.getEndtime());
    ...
    public static List getCache(FruitType type, int offset)
    {
