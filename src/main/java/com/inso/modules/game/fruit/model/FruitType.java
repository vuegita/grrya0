...
public enum FruitType implements GameChildType {

    PRIMARY("fruit_primary", "Primary",11, 1), // 1分钟
...
//    HIGH("ab_high", "High",13,1), // 1分钟
     ...
     * @param key
     */
    FruitType(String key, String title, int code, int stepOfMinutes)
    {
        this.key = key;
        this.title = title;
    ...
    public static FruitType getType(String key)
    {
