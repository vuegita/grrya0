...
public interface ReturnWaterOrderDao {

    public void addOrder(int level,String orderno, String outTradeNo, UserInfo userInfo, long agentid, FundAccountType accountType, ICurrencyType currencyType, OrderTxStatus txStatus, BigDecimal amount, Date createtime, RemarkVO remark);
