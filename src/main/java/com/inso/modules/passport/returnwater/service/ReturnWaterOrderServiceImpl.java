...
@Service
public class ReturnWaterOrderServiceImpl implements ReturnWaterOrderService {

    private BusinessType mReturnWaterBusinessType = BusinessType.RETURN_WATER;

    @Autowired
    private ReturnWaterOrderDao mReturnWaterOrderDao;
    ...
    public String createOrder(int level, String outTradeNo, UserInfo userInfo, long agentid, FundAccountType accountType, ICurrencyType currencyType, BigDecimal amount, Date createtime, RemarkVO remark)
    {
        ...
        mReturnWaterOrderDao.addOrder(level, orderno, outTradeNo, userInfo, agentid, accountType, currencyType, OrderTxStatus.NEW, amount, createtime, remark);
        return orderno;
    }
