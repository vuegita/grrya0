...
@Repository
public class ReturnWaterOrderDaoMysql extends DaoSupport implements ReturnWaterOrderDao {

    private static final String TABLE = "inso_passport_return_water_order";

    @Override
    public void addOrder(int level, String orderno, String outTradeNo, UserInfo userInfo, long agentid, FundAccountType accountType, ICurrencyType currencyType,
...
//        }
    ...
    public RowPager<ReturnWaterOrder> queryScrollPageByUser(PageVo pageVo, long userid, long agentid,long staffid,  String systemNo, String outTradeNo, OrderTxStatus txStatus, OrderTxStatus ignoreTxStatus)
    {
        ...
        String countsql = "select count(1) from inso_passport_return_water_order " + whereSQL;
        ...
        StringBuilder select = new StringBuilder("select * from inso_passport_return_water_order ");
