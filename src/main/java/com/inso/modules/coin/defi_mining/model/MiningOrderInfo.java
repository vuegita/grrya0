...
public class MiningOrderInfo {
    ...
    public static enum OrderType {
        REWARD("reward"), // 挖矿收益
        Staking("Staking"), // 质押收益

        WITHDRAW_2_BALANCE("withdraw_2_balance"), // 提现到余额

        VOUCHER_NODE_NOT_SETTLE("voucher_node_not_settle"), // voucher_node 不结算收益
        VOUCHER_STAKING_NOT_SETTLE("voucher_staking_not_settle"), // voucher_node 不结算收益
        ;
