...
@Repository
public class CloudOrderDaoMysql extends DaoSupport implements CloudOrderDao {
     ...
     */
    private static final String TABLE = "inso_coin_cloud_mining_order";
                         ...
                         BigDecimal totalAmount, BigDecimal feemoney, JSONObject jsonObject)
    {
        ...
        keyvalue.put("order_product_type", productType.getKey());
    ...
    public CloudOrderInfo findById(String orderno)
    {
        ...
        return mSlaveJdbcService.queryForObject(sql, CloudOrderInfo.class, orderno);
    }

    @Override
    public RowPager<CloudOrderInfo> queryScrollPage(PageVo pageVo, String sysOrderno, long agentid, long staffid, long userid, CryptoCurrency currency,
                                                    OrderTxStatus status, CloudProductType productType , CloudOrderInfo.OrderType orderType)
    {
        ...
        else
        {
            ...
            if(productType != null)
            {
                values.add(productType.getKey());
                whereSQLBuffer.append(" and order_product_type = ? ");
            }
        ...
        List<CloudOrderInfo> list = mSlaveJdbcService.queryForList(select.toString(), CloudOrderInfo.class, values.toArray());
        RowPager<CloudOrderInfo> rowPage = new RowPager<>(total, list);
        return rowPage;
    }
