...
public class MoneyOrderController {
    ...
    public String getUserMoneyOrderList()
    {
        ...
        RowPager<MoneyOrder> rowPager = moneyOrderService.queryScrollPage(pageVo, userid, agentid, staffid, systemOrderno, outTradeno, currencyType, orderType, txStatus);
