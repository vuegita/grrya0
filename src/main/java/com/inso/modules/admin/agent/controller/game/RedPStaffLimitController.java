...
public class RedPStaffLimitController {
    ...
    @RequestMapping("/red_package/staff_limit/page")
    public String toAgentStafflimitList(Model model)
    {
        return "admin/agent/game/agent_game_red_package_staff_limit_list";
    }

//    @RequiresPermissions("agent_game_red_package_staff_limit_list")
    ...
    public String toAddStaffLimitPage(Model model)
    {
        ...
        return "admin/agent/game/agent_game_red_package_staff_limit_edit";
    }

    //@RequiresPermissions({"root_game_red_package_staff_limit_edit"})
    @RequestMapping("/editAgentStaffLimit")
    @ResponseBody
    public String editAgentStaffLimit()
    {
