...
public class LotteryConfigController {
    ...
    @RequiresPermissions("root_game_lottery_rg_config_list")
    @RequestMapping("root_game_lottery_rg_config")
    public String toBasicPlatformConfig(Model model)
    {
        List<ConfigKey> configList = mConfigService.findByList(false, "game_lottery_rg");
        ...
        return "admin/game/game_lottery_rg_config";
    }

    @RequiresPermissions("root_game_lottery_rg_config_edit")
    @RequestMapping("updateGameLotteryConfig")
    @ResponseBody
    public String updateGameLotteryConfig()
    {
        ...
        for (String key : keys)
        {
            ...
            {
                mConfigService.updateValue("game_lottery_rg:" + key, value);
            }
        }

        // 更新缓存
        mConfigService.findByList(true, "game_lottery_rg");
    ...
    private void updateNumberConfigToDB(String key, long minValue, long maxValue)
    {
        ...
        {
            mConfigService.updateValue("game_lottery_rg:" + key, value + StringUtils.getEmpty());
        }
    }
