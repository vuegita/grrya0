...
public class FootballConfigController extends BaseLotteryConfigController {


    @Override
    public String getModuleRelateUrl() {
        return "root_game_football_config";
    }

    @Override
    public String getPrefixConfigKey() {
        return "game_football";
    }

    @RequiresPermissions("root_game_football_config_list")
    @RequestMapping("root_game_football_config")
    public String toBasicPlatformConfig(Model model)
    {
        return toListPage(model, FootballType.Football);
    }

    @RequiresPermissions("root_game_football_config_edit")
    @RequestMapping("root_game_football_config/updateGameConfig")
    @ResponseBody
