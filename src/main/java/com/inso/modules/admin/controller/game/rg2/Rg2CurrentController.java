...
public class Rg2CurrentController extends BaseLotteryCurrentController {


    @Override
    public String getModuleRelateUrl() {
        return "root_game_rg2_period_current";
    }
     ...
     * @return
     */
    @RequiresPermissions("root_game_rg2_period_current_list")
    @RequestMapping("root_game_rg2_period_current")
    public String toCurrentRunningPeriod(Model model)
    {
        return super.toPageList(model, RedGreen2Type.PARITY);
    }


    @RequiresPermissions("root_game_rg2_period_current_list")
    @RequestMapping("root_game_rg2_period_current/getDataList")
    @ResponseBody
     ...
     */
    @RequiresPermissions("root_game_rg2_period_current_list")
    @RequestMapping("/root_game_rg2_period_current/getGameRunningStatus")
    @ResponseBody
    ...
    @RequiresPermissions("root_game_rg2_period_current_edit")
    @RequestMapping("root_game_rg2_period_current/updateGameCurrentOpenResult")
    @ResponseBody
