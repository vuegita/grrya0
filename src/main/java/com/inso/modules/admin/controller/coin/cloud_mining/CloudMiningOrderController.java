...
//    private ApproveAuthService mApproveAuthService;
    ...
    @RequiresPermissions("root_coin_cloud_mining_order_list")
    ...
    public String toPage(Model model)
    {
        ...
        CloudOrderInfo.OrderType.addModel(model);

        model.addAttribute("networkTypeArr", CryptoNetworkType.getNetworkTypeList());
        return "admin/coin/cloud_mining/coin_cloud_mining_order_list";
    }
    ...
    @RequiresPermissions("root_coin_cloud_mining_order_edit")
    @RequestMapping("updateCoinCloudMiningOrderInfo")
    @ResponseBody
    public String updateCoinCloudMiningOrderInfo()
    {
