...
public class MemberEventLogController {
...
//
    ...
    @RequiresPermissions("root_sys_event_member_log_list")
    @RequestMapping("root_sys_event_member_log")
    public String toList(Model model)
    {
        WebEventLogType.addModel(model);
        return "admin/core/web_event_member_log_list";
    }


    @RequestMapping("getWebMemberEventLogList")
    @ResponseBody
    public String getDataList()
    {
        ...
        WebEventLogType logType = WebEventLogType.MEMBER_LOGIN;
        ...
        WebEventLogType tbType = WebEventLogType.MEMBER_LOGIN;
        RowPager<WebEventLogInfo> rowPager = mLogService.queryScrollPage( pageVo, null , agentid, tbType, operator, ignoreOperator);
