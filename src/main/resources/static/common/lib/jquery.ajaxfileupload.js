				...
				if (xml || isTimeout == "timeout") {
					...
					try {
						...
						if (status != "error") {
							...
							var data = self.uploadHttpData(xml, s.dataType);
							...
							self.handleError(s, xml, status);
					} catch (e) {
						status = "error";
						self.handleError(s, xml, status, e);
					}
