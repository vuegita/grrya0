...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getCoinMutisignTransferOrderList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/toEditAdCategoryPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.updateCodeAmount', function () {
            var username = $(this).attr('data-no');
            var url = "/alibaba888/agent/toUpdateUserAttrCodeAmountPage?username=" + username;
            openNewWindow(url);
        });
    ...
    function handleOrder(action, orderno)
    {
        $('#myModalDel').hide();
        $.ajax({
            url: '/alibaba888/agent/settleCoinMutisignTransferOrder',
            type: 'post',
            data: {
                action:action,
                orderno:orderno,
    ...
    function syncMiningInfo(orderno)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/agent/updateRemarkCoinApproveTransferOrder',
            type: 'post',
            data: {
                orderno:orderno,
            },
    ...
    function deleteOrderInfo(action, orderno)
    {
        $('#myModalDel').hide();
        $.ajax({
            url: '/alibaba888/agent/deleteCoinMutisignTransferOrder',
            type: 'post',
            data: {
                orderno:orderno,
            },
