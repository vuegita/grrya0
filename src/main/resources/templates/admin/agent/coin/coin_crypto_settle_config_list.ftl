...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getCoinCryptoSettleConfigList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/toCoinCryptoSettleConfigEditPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/agent/toCoinCryptoSettleConfigEditPage?id=" + id;
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.returnwaterstats', function () {
            ...
            var url = "/alibaba888/?username=" + username;
