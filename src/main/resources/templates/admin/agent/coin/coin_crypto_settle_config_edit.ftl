...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <p  style="color: green">4.分红比例仅在总后台配置</p>
...
<#--                <div class="hr-line-dashed"></div>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" name="shareRatio" id="shareRatio" autocomplete="off" placeholder="分红比例仅在总后台设置"
                               required type="text" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'');" readonly
        ...
        $("#submitBtn").click(function () {
           ...
           // var shareRatio = $('input[name="shareRatio"]').val();
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/agent/updateCoinCryptoSettleConfigInfo",
                data: {
                    id:id.trim(),
                    // key:key.trim(),
