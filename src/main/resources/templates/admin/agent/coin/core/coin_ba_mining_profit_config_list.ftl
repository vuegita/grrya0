...
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getCoinCoreMiningProfitConfigList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/toCoinCoreMiningProfitConfigEditPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/agent/toCoinCoreMiningProfitConfigEditPage?id=" + id;
            openNewWindow(url);
        });
