        ...
        <div class="ibox-content">
            ...
            <form id="form" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control" id="profitType" name="profitType" >
                            <#if entity?exists>
                                <option value="${entity.getProfitType()}">${entity.getProfitType()} </option>
                            <#else>
                                <option value="">---请选择分类--- </option>
                                <#list profitTypeArr as item>
                                    <#if !item.isOnlySupportAdmin()>
...
<#--                            <label>-->
<#--                                <input type="radio"  name="currencyType" id="currencyType" value="USDT"-->
<#--                                        <#if entity?exists && entity.currencyType == 'USDT'> checked </#if>/>-->
<#--                                <i></i>USDT-->
<#--                            </label>-->

<#--                            <label><input type="radio"  name="currencyType" id="currencyType" value="USDC"-->
<#--                                        <#if entity?exists && entity.currencyType == 'USDC'> checked </#if>/>-->
<#--                                <i></i>USDC-->
<#--                            </label>-->
...
<#--                <div class="hr-line-dashed"></div>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5" style="color: red">日收益率范围0~1, 例：1%的话填写0.01</div>
                </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            var profitType = $('select[name="profitType"]').val();
            ...
            if(isEmpty(status) || isEmpty(currencyType))
            {
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/agent/updateCoinCoreMiningProfitConfig",
                data: {
                    id:id.trim(),

                    profitType:profitType.trim(),
