...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <p  style="color: green">1. 统计上级其所拥有下级员工数据(会员数据已累加到员工中)</p>
            <p  style="color: green">2.盈亏总额=用户充值-用户提现+退款</p>
            <p  style="color: green">3.净利差总额=下单扣款 - 下单返奖 + 平台扣款 - 平台充值 - 平台赠送 - 返佣总额!</p>
        </div>
        ...
        <div class="ibox-content">
            <div class="btn-group hidden-xs" id="bootstrapTableToolBar" role="group">
                ...
                <div class="pull-left hidden" style="margin-right: 10px;">
                    <input type="hidden" name="ancestorUsername" id="ancestorUsername" class="form-control input-outline" readonly placeholder="请点击查看下级">
                </div>
...
<#--                        class="title">日期-->
<#--                    </th>-->
                    <th data-field="id" data-formatter="actionFormatter2" data-width="5%" data-align="center">盈亏总额</th>
                    <th data-field="id" data-formatter="actionFormatter3" data-width="5%" data-align="center">净利差总额</th>
...
<script type="text/javascript">
    ...
    function actionFormatter2(value, row, index) {
        ...
        result = row.recharge-row.withdraw +row.refund;
    ...
    function actionFormatter3(value, row, index) {
        ...
        result = row.businessDeduct-row.businessRecharge + row.platformDeduct -row.platformRecharge -row.platformPresentation -row.returnWater;
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getUserAgentReportList';
        options.search = false;
        options.showRefresh = true;
        options.queryParams = function (params) {
            params.ancestorUsername = $('input[name="ancestorUsername"]').val();
