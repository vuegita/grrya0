...
<#--                    <div class="pull-left" style="margin-left: 10px;">-->
<#--                        <button id="refuseAudit2-btn" type="button" class="btn btn-outline btn-default" title="结算订单">-->
<#--                            结算订单-->
<#--                        </button>-->
<#--                    </div>-->
...
<#--                    <div class="pull-left" style="margin-right: 10px;">  </div>-->
                        <input type="hidden" name="reportid" id="reportid" class="form-control input-outline"
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="txStatus" >
                        ...
                        <option value="realized" selected>可结算</option>
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="settleStatus" >
                        ...
                        <option value="waiting"  selected>未结算</option>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.table-btn.toAgentSettleOrderPage', function () {
        ...
        var url = '/alibaba888/agent/root_coin_crypto_approve_transfer?sysOrderno=' + sysOrderno +"&username="+ username;
    ...
    function reWithdrawOrder(no) {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "/alibaba888/?????/reWithdrawOrder",
            data: {
                no:no.trim(),
            },
            dataType: "json",
    ...
    function reWithdrawOrder2(no) {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "/alibaba888/???????/backgroundRewithdraw",
            data: {
                no:no.trim(),
            },
            dataType: "json",
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getWebSettleOrderList';
    ...
    function handleOrderStatus(orderno, action) {
        $.ajax({
            type: "post",
            // async: false,
            url: "updateWebSettleOrderStatus",
            data: {
    ...
    $('#refuseAudit2-btn').click(function () {
        ...
        if(selected&&selected.length>0){
            ...
            $.ajax({
                type: "post",
                // async: false,
                url: "/alibaba888/agent/addSettleWithdrawReport",
                data: {
