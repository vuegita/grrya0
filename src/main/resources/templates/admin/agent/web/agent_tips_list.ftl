...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getWebAgentTipsList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/toAddWebAgentTipsPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            var url = '/alibaba888/agent/toAddWebAgentTipsPage?id=' + memberid;
            openNewWindow(url);
        });
