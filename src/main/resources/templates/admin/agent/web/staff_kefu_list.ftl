...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <p  style="color: green">2. 有客服类型chatwoot,tawk的客服时其他类型客服不显示!</p>
            <p  style="color: green">3. 客服类型chatwoot,tawk 是在线客服（同时存在时只有一个在线客服生效）</p>
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/web/getWebStaffKefuList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/web/toAddWebStaffKefuPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            var url = '/alibaba888/agent/web/toAddWebStaffKefuPage?id=' + memberid;
            openNewWindow(url);
        });
