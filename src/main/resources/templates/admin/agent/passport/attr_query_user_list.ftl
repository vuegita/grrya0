...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            <div style="width: 100%"><h5>查询注册到总后台会员</h5></div>

            <div style="color:red;width: 100%">页面提示 “正在努力地加载数据中，请稍候…” 就是没有这个用户或者已注册到别的代理下</div>
        </div>
        ...
        <div class="ibox-content">
            <div class="btn-group hidden-xs" id="bootstrapTableToolBar" role="group">
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="address" id="address" class="form-control input-outline"  placeholder="请输入用户钱包地址" style="width:150px;">
                </div>
...
<#--                    <th data-field="codeAmount" data-width="8%" data-align="center"-->
<#--                        class="title">打码量-->
<#--                    </th>-->
...
<#include "user_list_update_agent_relation.ftl">
...
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/passport/getUserSystemStaffAttrList';
