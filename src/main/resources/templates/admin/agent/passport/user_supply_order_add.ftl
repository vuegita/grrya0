                    ...
                    <div class="col-sm-6">
                        <select class="form-control" id="currencyType" name="currencyType" >
                            <#list currencyTypeList as item>
                                ...
                                <#if currentCurrency == '${item.getKey()}'> selected </#if>
                                >${item.getKey()} | ${item.getCategory()} </option>
                            </#list>
                        </select>
                    </div>
                </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#search-btn').click(function(){
            ...
            $.ajax({
                url: '/alibaba888/agent/passport/findUserInfo',
                type: 'post',
                dataType: 'json',
                data:{
                    username: username,
    ...
    function addSupply() {
        ...
        $.ajax({
            url: '/alibaba888/agent/addPlatformSupply',
            type: 'post',
            dataType: 'json',
            data:{
                username: username,
