...
<#--                </div>-->
                ...
                <#if isShow == "enableAll" || isShow == "refuse" >
                <div class="pull-left" style="margin-left: 10px;">
...
<#--                        class="title">受益人账户-->
<#--                    </th>-->
<#--                    <th data-field="no" data-width="5%" data-align="center"  data-formatter="beneficiaryIFSCFormatter"-->
<#--                        class="title">IFSC-->
<#--                    </th>-->
...
<#--                    </th>-->
                    ...
                    <#if isAgent == "true" >
                     ...
                     <#else>
                         ...
                         <#if isShow == "refuse" >
                             <th data-field="no" data-width="8%" data-align="center" data-formatter="actionFormatter2"
                                 class="title">操作
                             </th>
                         </#if>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        debugger
        options.url = '/alibaba888/agent/passport/getAuditUserWithdrawList';
        ...
        $('#passAudit-btn').click(function () {
            ...
            if(selected&&selected.length>0){
                ...
                $.each(selected,function(index,item){
                    $.ajax({
                        url: '/alibaba888/agent/passport/doAuditUserWithdrawOrder',
                        type: 'post',
                        dataType: 'json',
