...
<#--                        data-formatter="statusFormatter"-->
                    ...
                    <th data-field="createtime" data-width="10%" data-align="center" data-sortable="true"
                        class="title">创建时间
                    </th>

<#--                    <th data-field="updatetime" data-width="10%" data-align="center" data-sortable="true"-->
<#--                        class="title">更新时间-->
<#--                    </th>-->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/passport/getRechargeOrderList';
