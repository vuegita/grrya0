...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="type" >
                        ...
                        <option value="refund" >用户退款</option>
                    </select>
                </div>
...
<#--                    </th>-->
                    ...
                    <th data-field="realmoney" data-width="5%" data-align="center"
                        class="title">实际金额
                    </th>
...
<#--                    </th>-->
                    ...
                    <th data-field="" data-width="15%" data-align="left" data-formatter="detailInfoFormatter"
                        class="title">订单明细
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/root_passport_user_supply_order/getDataList';
        ...
        $(document).on('click', '#create-btn', function () {
            //var url = '/alibaba888/agent/toApplyPlatformSupplyPage';
            //openNewWindow(url);
        });
