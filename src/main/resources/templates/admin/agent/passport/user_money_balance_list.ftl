...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="fundAccountType" >
                        <option value="" >---资金账户---</option>
...
<#--                    <th data-field="id" data-formatter="noActionFormatter" data-width="5%" data-align="center">#</th>-->
                    ...
                    <th data-field="fundKey" data-width="5%" data-align="center"
                        class="title">资金账户
                    </th>
...
<#--        <#if systemRunningMode=='crypto' || environment == "dev">-->
//             result += '<a href="javascript:;" class="table-btn tranferBalance" data-no="' + row.username + '"  title="资金划转">资金划转</a>';
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/getUserMoneyBalanceList';
        ...
        options.queryParams = function (params) {
            ...
            params.fundAccountType = $('select[name="fundAccountType"]').val();
        ...
        $('#reset-btn').click(function () {
            ...
            $('select[name="fundAccountType"]').val('');
