...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="withdrawlAmount" data-width="5%" data-align="center"
                        class="title">提现额度
                    </th>
                    ...
                    <th data-field="begintime" data-width="8%" data-align="center"
                        class="title">开始时间
                    </th>

                    <th data-field="expirestime" data-width="8%" data-align="center"
                        class="title">过期时间
                    </th>
...
<#include "../../passport/user_vip_edit_withdrawl_quote.ftl">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/passport/getPassportUserVIPList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/passport/toEditPassportUserVIPPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/agent/passport/toEditPassportUserVIPPage?id=" + id;
            openNewWindow(url);
        });
