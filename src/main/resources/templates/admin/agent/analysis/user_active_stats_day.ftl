...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <p  style="color: green">1. 时长单位为秒</p>
        </div>
...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="fetchFrom" >
                        <option value="staff" >员工汇总</option>
                        <option value="member" >会员汇总</option>
                    </select>
                </div>
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="hours" data-width="8%" data-align="center"
                        class="title">所在小时
                    </th>
                    ...
                    <th data-field="onlineDuration" data-width="8%" data-align="center" data-formatter="actionFormatterOnlineDuration"
                        class="title">总时长
                    </th>

<#--                    <th data-field="stayRgDuration" data-width="8%" data-align="center"-->
<#--                        class="title">红绿时长-->
<#--                    </th>-->

<#--                    <th data-field="stayAbDuration" data-width="8%" data-align="center"-->
<#--                        class="title">AB时长-->
<#--                    </th>-->

<#--                    <th data-field="stayFruitDuration" data-width="8%" data-align="center"-->
<#--                        class="title">水果机时长-->
<#--                    </th>-->

<#--                    <th data-field="stayFmDuration" data-width="8%" data-align="center"-->
<#--                        class="title">理财时长-->
<#--                    </th>-->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //options.url = '/alibaba888/Liv2sky3soLa93vEr62/getDataAnalysisUserActiveStatsDayList';
        options.url= '/alibaba888/agent/basic/overview/getDataAnalysisUserActiveStatsDayList',
        ...
        options.queryParams = function (params) {
            ...
            params.fetchFrom = $('select[name="fetchFrom"]').val();
            return params;
        };
    ...
    function actionFormatterOnlineDuration(value, row, index) {
