...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/agent/game/getStaffLimitList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/agent/game/toAddStaffLimitPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            debugger
            var url = '/alibaba888/agent/game/toAddStaffLimitPage?staffid=' + staffid;
            openNewWindow(url);
        });
