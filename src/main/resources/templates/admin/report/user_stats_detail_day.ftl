        ...
        <div class="ibox-content">
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="returnFirstRechargeLv1Amount" data-width="5%" data-align="center" data-formatter="columnFormatterForMoney"
                        class="title">首充返Lv1
                    </th>

                    <th data-field="returnFirstRechargeLv2Amount" data-width="5%" data-align="center" data-formatter="columnFormatterForMoney"
                        class="title">首充返Lv2
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/root_report_day_user_stats_detail_v2/getDataList';
