...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="" data-width="5%" data-align="left" data-formatter="userInfoFormatter"
                        class="title">用户详情
                    </th>

                    <th data-field="" data-width="5%" data-align="left" data-formatter="userAmountStatsFormatter"
                        class="title">用户汇总
                    </th>

                    <th data-field="" data-width="5%" data-align="left" data-formatter="userSubAmountStatsFormatter"
                        class="title">下级汇总
                    </th>

                    <th data-field="" data-width="5%" data-align="left" data-formatter="platformAmountStatsFormatter"
                        class="title">平台汇总
                    </th>

                    <th data-field="" data-width="5%" data-align="left" data-formatter="businessAmountStatsFormatter"
                        class="title">业务汇总
                    </th>
...
<#--                    <th data-field="balance" data-width="5%" data-align="center" data-formatter="columnFormatterForMoney"-->
<#--                        class="title">实时余额-->
<#--                    </th>-->
...
<script type="text/javascript">
    ...
    function userInfoFormatter(value, row, index) {
        ...
        result += "资金账户: " + row.fundKey + " <br>";
        result += "所属币种: " + row.currency + " <br>";
        result += "创建日期: " + row.pdate + " <br>";

        return result;
    }

    function userAmountStatsFormatter(value, row, index) {
        var result = "";
        result += "用户充值: " + row.recharge + " <br>";
        result += "用户提现: " + row.withdraw + " <br>";
        result += "退款总额: " + row.refund + " <br>";
        result += "手续费总额: " + row.feemoney + " <br>";

        return result;
    }

    function userSubAmountStatsFormatter(value, row, index) {
        var result = "";

        result += "一级充值总额: " + row.lv1Recharge + " <br>";
        result += "一级提现总额: " + row.lv1Withdraw + " <br>";

        result += "二级充值总额: " + row.lv2Recharge + " <br>";
        result += "二级提现总额: " + row.lv2Withdraw + " <br>";

        return result;
    }

    function platformAmountStatsFormatter(value, row, index) {
        var result = "";
        result += "平台充值: " + row.platformRecharge + " <br>";
        result += "平台赠送: " + row.platformPresentation + " <br>";
        result += "平台扣款: " + row.businessDeduct + " <br>";

        return result;
    }

    function businessAmountStatsFormatter(value, row, index) {
        var result = "";
        result += "下单返奖: " + row.businessRecharge + " <br>";
        result += "下单扣款: " + row.businessDeduct + " <br>";
        result += "下单手续费: " + row.businessFeemoney + " <br>";
        result += "返佣总额: " + row.businessFeemoney + " <br>";
