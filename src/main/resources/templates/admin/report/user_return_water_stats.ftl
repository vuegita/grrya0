...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="level1Amount" data-width="8%" data-align="center"
                        class="title">一级返佣总额
                    </th>

                    <th data-field="level1Count" data-width="8%" data-align="center" data-formatter="actionFormatter"
                        class="title">一级总人数
                    </th>

                    <th data-field="level2Amount" data-width="8%" data-align="center"
                        class="title">二级返佣总额
                    </th>

                    <th data-field="level2Count" data-width="8%" data-align="center" data-formatter="actionFormatter2"
                        class="title">二级总人数
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getUserReturnLogRecord';
