        ...
        <div class="ibox-content">
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="betAmount" data-width="5%" data-align="center" data-formatter="columnFormatterForMoney"
                        class="title">投注总额
                    </th>

                    <th data-field="betCount" data-width="5%" data-align="center"
                        class="title">投注总数
                    </th>

                    <th data-field="winAmount" data-width="5%" data-align="center" data-formatter="columnFormatterForMoney"
                        class="title">中奖总额
                    </th>

                    <th data-field="winAmount2" data-width="5%" data-align="center" data-formatter="columnFormatterForMoney"
                        class="title">中奖总额(不扣手续)
                    </th>

                    <th data-field="winCount" data-width="5%" data-align="center"
                        class="title">中奖总数
                    </th>
                    ...
                    <th data-field="" data-width="5%" data-align="center" data-formatter="platformProfitDataFormatter2"
                        class="title">平台盈亏(不扣手续)
                    </th>
...
<script type="text/javascript">
    ...
    function platformProfitDataFormatter2(value, row, index) {
        return (row.betAmount - row.winAmount2).toFixed(2);
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getBusinessReportList';
