...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="type" >
                        ...
                        <option value="simple" >普通红包</option>
                        <option value="solid" >固定红包</option>
                        <option value="Specify" >指定红包</option>
                    </select>
                </div>
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="rpid" data-width="5%" data-align="center"
                        class="title">红包ID
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getGameRedPReceivOrderList';
