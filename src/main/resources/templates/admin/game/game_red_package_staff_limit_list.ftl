...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <p  style="color: green">1. 每个员工都有唯一一个绑定!</p>
        </div>
...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="agentname" id="agentname" class="form-control input-outline"  placeholder="请输入代理" style="width:200px;">
                </div>
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="maxMoneyOfSingle" data-width="8%" data-align="center"
                        class="title">单笔最大金额
                    </th>
                    <th data-field="maxMoneyOfDay" data-width="8%" data-align="center"
                        class="title">每日最大金额
                    </th>

                    <th data-field="maxCountOfDay" data-width="8%" data-align="center"
                        class="title">每天发送红包次数
                    </th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        var result = "";
        debugger
        result += '<a href="javascript:;" class="table-btn modifyMember" data-no="' + row.staffid + '" title="编辑">编辑</a>';
        return result;
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getStaffLimitList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddStaffLimitPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.modifyMember', function () {
            var staffid = $(this).attr('data-no');
            debugger
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddStaffLimitPage?staffid=' + staffid;
            openNewWindow(url);
        });
