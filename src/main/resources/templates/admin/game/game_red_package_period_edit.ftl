...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <p  style="color: green">4. 充值红包: 只有当充值完成时,才能获取红包里面的赠送金额</p>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="radio i-checks">
                            ...
                            <label><input type="radio"  name="type" id="type" value="solidCode" <#if periodInfo?exists> readonly </#if>>
                                <i></i>固定红包无打码
                            </label>

<#--                            <label><input type="radio"  name="type" id="type" value="recharge" <#if periodInfo?exists> readonly </#if>>-->
<#--                                <i></i>充值红包-->
<#--                            </label>-->
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2">领取需最少金额:</label>
                    <div class="col-sm-3">
                        <input class="form-control" name="externalLimitMinxAmount" id="externalLimitMinxAmount" autocomplete="off" <#if periodInfo?exists> readonly </#if>
                               required type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'');" value="200" placeholder="" />
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <label class="control-label" style="color: red;margin-left: 100px">1. 外部金额限制条件, 当前只支持充值红包 !!!</label><br>
                        <label class="control-label" style="color: red;margin-left: 100px">2. 如选择红包类型为充值红包，并且设置为200，表示当充值金额>=200并且完成充值时，才能获得红包金额 !!!</label><br>
                        <label class="control-label" style="color: red;margin-left: 100px">3. 当前最小值为100 !!!</label><br>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control" name="remark" id="remark" autocomplete="off" maxlength="30"
                               required type="text"  value=""  placeholder="备注"/>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    $(function () {
        ...
        function doSubmit()
        {
            ...
            var externalLimitMinxAmount = $('input[name="externalLimitMinxAmount"]').val();
            ...
            if(isEmpty(externalLimitMinxAmount) || externalLimitMinxAmount < 100)
            {
                $.global.openErrorMsg('领取设置最小金额条件为 100 !');
                return;
            }


            var maxCount = Number(totalAmount) / 0.01;
            if(maxCount > 1000)
            {
                maxCount = 1000;
            }
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/game/red_package/create",
                data: $('#form').serialize(),
                dataType: "json",
