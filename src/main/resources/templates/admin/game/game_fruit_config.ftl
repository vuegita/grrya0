...
<#--                                    <label><input type="radio" name="open_mode" disabled value="random" <#if config.open_mode == "random">checked</#if>> <i></i>随机开奖</label>-->
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2">游戏难度:</label>
                            <div class="col-sm-3">
                                <div class="radio i-checks">
                                    <label><input type="radio" name="open_game_difficulty" value="low" <#if config.open_game_difficulty == "low">checked</#if>> <i></i>真正随机</label>
                                    <label><input type="radio" name="open_game_difficulty" value="middle" <#if config.open_game_difficulty == "middle">checked</#if>> <i></i>中等难度</label>
                                    <label><input type="radio" name="open_game_difficulty" value="high" <#if config.open_game_difficulty == "high">checked</#if>> <i></i>高难度</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label" style="color: red;margin-left: 100px">1. 游戏难度：随机开奖时出现高赔率的概率 难度越高出现高赔率的概率就越小</label><br>
...
<script type="text/javascript">
    ...
    $('#delete_submit').click(function () {
        ...
        $.ajax({
            ...
            url: "/alibaba888/Liv2sky3soLa93vEr62/updateGameFruitConfig" ,//url
            data: $('#form').serialize(),
