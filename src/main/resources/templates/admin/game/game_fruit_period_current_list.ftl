...
<#--                    </th>-->
                    ...
                    <th data-field="openResult" data-width="5%" data-align="center" data-formatter="platformProfitFormatter2"
                        class="title">开奖选项
                    </th>
...
<script type="text/javascript">
    ...
    function platformProfitFormatter2(value, row, index) {
        debugger
        var openResult = row.openResult;
        if(openResult=="dw"){
            return  "大王("+ openResult+")";
        }else if(openResult=="sx"){
            return  "双星("+ openResult+")";
        }else if(openResult=="xg"){
            return  "西瓜("+ openResult+")";
        }else if(openResult=="qq"){
            return  "77("+ openResult+")";
        }else if(openResult=="hz"){
            return  "黄钟("+ openResult+")";
        }else if(openResult=="pg"){
            return  "苹果("+ openResult+")";
        }else if(openResult=="jz"){
            return  "橘子("+ openResult+")";
        }else if(openResult=="nm"){
            return  "柠檬("+ openResult+")";
        }else if(openResult=="xdw"){
            return  "小王("+ openResult+")";
        }else if(openResult=="xsx"){
            return  "小双星("+ openResult+")";
        }else if(openResult=="xxg"){
            return  "小西瓜("+ openResult+")";
        }else if(openResult=="xqq"){
            return  "小77("+ openResult+")";
        }else if(openResult=="xhz"){
            return  "小黄钟("+ openResult+")";
        }else if(openResult=="xpg"){
            return  "小苹果("+ openResult+")";
        }else if(openResult=="xjz"){
            return  "小橘子("+ openResult+")";
        }else if(openResult=="xnm"){
            return  "小柠檬("+ openResult+")";
        }else if(openResult=="takeall"){
            return  "通杀("+ openResult+")";
        }else{
            return openResult;
        }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCurrentGameFruitPeriodRunningReportList';
    ...
    function loadGameRunningStatus() {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/getGameFruitLotteryStatus',
            type: 'post',
            dataType: 'json',
            data: {
    ...
    function updateOpenResult(openResult) {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateLotteryCurrentFruitOpenResult',
            type: 'post',
            dataType: 'json',
            data: {
                issue:issue,
