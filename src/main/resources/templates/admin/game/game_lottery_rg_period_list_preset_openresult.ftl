                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control" name="openResult" id="openResult" autocomplete="off"
                               style="width: 300px;"
                               minlength="100" onkeyup="this.value=this.value.replace(/[^\d]{1}/g,'');" />
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    function resetLotteryOpenResult() {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/resetLotteryOpenResult',
            type: 'post',
            dataType: 'json',
            data: {
    ...
    function loadPresetOpenResult(issue) {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/getLotteryPeriodInfo',
            type: 'post',
            dataType: 'json',
            data: {
                issue:issue
