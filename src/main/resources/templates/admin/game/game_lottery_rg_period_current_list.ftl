...
<#--            <p  style="color: green">开奖请在倒计时60秒后设置</p>-->
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCurrentGameRgPeriodRunningReportList';
    ...
    function loadGameRunningStatus() {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/getGameRgLotteryStatus',
            type: 'post',
            dataType: 'json',
            data: {
    ...
    function updateOpenResult(openResult) {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateLotteryCurrentOpenResult',
            type: 'post',
            dataType: 'json',
            data: {
                issue:issue,
