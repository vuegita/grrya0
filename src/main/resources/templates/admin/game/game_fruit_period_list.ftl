...
<#include "./game_fruit_period_list_preset_openresult.ftl">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getGameFruitPeriodList';
    ...
    function reSettleAllLotteryOrder(issue) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/reSettleAllGameFruitOrder',
            type: 'post',
            dataType: 'json',
            data: {
                issue:issue,
