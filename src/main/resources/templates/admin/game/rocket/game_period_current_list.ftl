        ...
        <div class="ibox-content">
            ...
            <div class="btn-group hidden-xs" id="bootstrapTableToolBar" role="group">
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    ...
                    <input type="text" name="issueText" id="issueText" class="form-control input-outline"  placeholder="期号: " readonly style="width:220px;">
                </div>
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="openResult" id="openResult" class="form-control input-outline"  placeholder="当前结果: " readonly style="width:200px;">
                </div>
                ...
                <button id="stop-game-btn" type="button" class="btn btn-outline btn-default" title="结束游戏">
                    <i class="glyphicon glyphicon-refresh" aria-hidden="true"></i> 结束游戏
                </button>
...
<script type="text/javascript">
    ...
    function updateCountdownTimer()
    {
        refresh();
        window.setInterval(() => {
            console.log("========will refresh " + countdownSeconds);
            refresh();
        }, 10000);
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/root_game_rocket_period_current/getDataList';
        ...
        $(document).on('click', '.table-btn.presetOpenResult', function () {
            ...
            $('#presetOpenResultModal #id').val(openResult);
            $('#presetOpenResultModal #presetopenResult').val(openResult);

            $('#presetOpenResultModal #type').attr('action', 'presetOpenResult');
            $('#presetOpenResultModal #tips').text('确定开 ' + openResult + ' ？');
        ...
        $('#stop-game-btn').click(function () {
            $.ajax({
                url: '/game/rocketApi/sfsdsdfasldjflasdjfasldfuasldfjalsdujfalsdf987342345dfjgsdfgdfgsdfgsdfgklsdjfglsdjfglsdfjglsdfjglsdfjgsdlfjglsdkfgjlsdf',
                type: 'post',
                dataType: 'json',
                data: {
                    accessKey:accessKey,
    ...
    function loadGameRunningStatus() {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/root_game_rocket_period_current/getGameRunningStatus',
            type: 'post',
            dataType: 'json',
            data: {
            ...
            success: function (result) {
                if (result.code === 200) {
                    ...
                    $("#presetOpenResultIssue").prop("value", issue);
    ...
    function updateOpenResult(openResult) {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateGameRocketCurrentOpenResult',
            type: 'post',
            dataType: 'json',
            data: {
                issue:issue,
