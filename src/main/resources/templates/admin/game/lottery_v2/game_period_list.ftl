...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="totalWinAmount2" data-width="5%" data-align="center"
...
<#--                    </th>-->
                    ...
                    <th data-field="referenceExternal" data-width="5%" data-align="center"
                        class="title">参考价格
                    </th>
                    ...
                    <th data-field="openResult" data-width="5%" data-align="center"
                        data-formatter="srcReferenceFormatter"
                        class="title">原参考价格
                    </th>
...
<#include "game_period_list_batch_preset_openresult.ftl">
...
<script type="text/javascript">
    ...
    function resetTime()
    {
        ...
        var nowtime =new Date(new Date().getTime() - 86400 * 1000).Format("yyyy-MM-dd HH:mm:ss");
    ...
    function srcReferenceFormatter(value, row, index) {
        try {
            var json = JSON.parse(row.remark)
            if(json && json.realReference)
            {
                return json.realReference;
            }
        } catch (e) {
        }
        return "";
    ...
    function actionFormatter(value, row, index) {
        ...
        if(showPreset && row.status == 'pending')
        {
    ...
    function reSettleAllLotteryOrder(issue) {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/${moduleRelateUrl}/reSettleAllGameOrder',
            type: 'post',
            dataType: 'json',
            data: {
                issue:issue,
