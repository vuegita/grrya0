...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="extraFeemoney" data-width="5%" data-align="center"
                        class="title">额度单笔手续费
                    </th>
...
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getPayChannelList';
        ...
        $(document).on('click', '#create-btn', function(){
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditPayChannelPage";
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editChannelInfo', function () {
            var channelid = $(this).attr('data-channelid');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditPayChannelPage?channelid=" + channelid;
            openNewWindow(url);
        });
    ...
    function deletePayChannel(channelid) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deletePayChannel',
            type: 'post',
            dataType: 'json',
