...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="merchantname" data-width="5%" data-align="center"
                        class="title">所属商家
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getAdMallRecommendList';
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toAdMallRecommendInfoPage?id=" + id;
            openNewWindow(url);
        });
    ...
    function handleToDeleteItem(id) {

        $('#myModalDel').modal();

        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteAdMallRecommendInfo',
            type: 'post',
            data: {id:id},
            dataType: 'json',
            success: function (result) {
