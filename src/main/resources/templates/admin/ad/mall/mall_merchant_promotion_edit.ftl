        ...
        <div class="ibox-content">
            ...
            <form id="form" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" name="price" id="price" autocomplete="off"
                               required type="text" maxlength="50" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'');"
                               style="width:300px;"
                               value="<#if entity?exists> ${entity.price} </#if>" />
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" name="totalAmount" id="totalAmount" autocomplete="off"
                               required type="text" maxlength="50" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'');"
                               style="width:300px;"
                               value="<#if entity?exists> ${entity.totalAmount} </#if>" />
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
    ...
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/editAdMallPromotionInfo",
                data: {
                    id:id,
                    price: price,
