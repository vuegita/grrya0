...
<#--            <p  style="color: green">1. 最低和最高价格都要为5的倍数!</p>-->
        ...
        <div class="ibox-content">
            ...
            <form id="form" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>收货地址:</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" name="phone" id="phone" value="<#if entity?exists> ${entity.phone} </#if>" autocomplete="off" required maxlength="50"/>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            if ( isEmpty(location) || isEmpty(status) || isEmpty(phone)){
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/editAdMallBuyerAddrInfo",
                data: {
                    id:id,
                    location: location,
                    phone:phone,
