...
<#--                    </th>-->
                    ...
                    <th data-field="returnAmount" data-width="5%" data-align="center"
                        class="title">销售佣金
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getAdMallMerchantSalesReportList';
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallStorePage?id=" + id;
            openNewWindow(url);
        });
