...
<#--                    </th>-->
                    ...
                    <th data-field="phone" data-width="5%" data-align="center"
                        class="title">手机号码
                    </th>

                    <th data-field="location" data-width="5%" data-align="center"
                        class="title">收货地址
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getAdMallBuyerAddrList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallBuyerAddrPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallBuyerAddrPage?id=" + id;
            openNewWindow(url);
        });
