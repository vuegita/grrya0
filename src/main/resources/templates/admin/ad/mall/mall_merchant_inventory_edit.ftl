...
<#--                    </div>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" name="quantity" id="quantity" autocomplete="off"
...
<script type="text/javascript">
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            if ( isEmpty(materielid) || isEmpty(username)){
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/editAdMallPurchaseOrderInfo",
                data: {
                    id:id,
                    quantity:quantity,
                },
