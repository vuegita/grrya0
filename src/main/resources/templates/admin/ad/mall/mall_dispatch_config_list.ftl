...
<#--                </div>-->
                ...
                <#if isSuperAdmin=='true'>
                    <button id="batch-sync-btn" type="button" class="btn btn-outline btn-default" title="一键生成">
                        一键生成
                    </button>
                </#if>
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="minCount" data-width="5%" data-align="center"
                        class="title">派单最少值
                    </th>

                    <th data-field="maxCount" data-width="5%" data-align="center"
                        class="title">派单最大值
                    </th>

                    <th data-field="status" data-width="8%" data-align="center"
                        class="title">状态
                    </th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        var result = "";
        result += '<a href="javascript:;" class="table-btn editInfo" data-no="' + row.level + '" title="编辑">编辑</a>';
        return result;
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getAdMallDispatchConfigList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallStorePage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallDispatchConfigPage?id=" + id;
            openNewWindow(url);
        });
    ...
    function batchCreate()
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/batchAdMallDispatchConfigInfo',
            type: 'post',
            data: {},
            dataType: 'json',
