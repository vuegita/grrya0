        ...
        <div class="ibox-content">
            ...
            <form id="form" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>订单号:</label>
                    <div class="col-sm-5">
                        <input class="form-control" name="orderno" id="orderno" value="<#if entity?exists> ${entity.orderno} </#if>" autocomplete="off" required maxlength="50"/>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>

                <div class="form-group">
                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>当前位置:</label>
                    <div class="col-sm-5">
                        <input class="form-control" name="location" id="location" value="<#if entity?exists> ${entity.location} </#if>" autocomplete="off" required maxlength="50"/>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>

<#--                <div class="form-group">-->
<#--                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>到达状态:</label>-->
<#--                    <div class="col-sm-5">-->
<#--                        <div class="radio i-checks">-->
<#--                            <label>-->
<#--                                <input type="radio"  name="isFinish" id="isFinish" value="enable"-->
    ...
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/editAdMallDeliveryInfo",
                data: {
                    id:id,
                    status:status,
                },
