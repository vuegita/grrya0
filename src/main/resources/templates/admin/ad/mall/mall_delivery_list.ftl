...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="orderno" data-width="5%" data-align="center"
                        class="title">订单号
                    </th>

<#--                    <th data-field="index" data-width="5%" data-align="center"-->
<#--                        class="title">索引号-->
<#--                    </th>-->

                    <th data-field="location" data-width="15%" data-align="center"
                        class="title">当前位置
                    </th>

<#--                    <th data-field="trackno" data-width="5%" data-align="center"-->
<#--                        class="title">快递号-->
<#--                    </th>-->
                    ...
                    <th data-field="finish" data-width="5%" data-align="center"
                        data-formatter="columnFormatterForBoolvalue"
                        class="title">最后物流
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getAdMallDeliveryList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallDeliveryPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditAdMallDeliveryPage?id=" + id;
            openNewWindow(url);
        });
