...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <p  style="color: green">2. 返佣利率只针对Shop使用,其它不起作用!</p>
...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="minPrice" data-width="5%" data-align="center"
                        class="title">最低价格
                    </th>

                    <th data-field="maxPrice" data-width="5%" data-align="center"
                        class="title">最高价格
                    </th>

                    <th data-field="returnRate" data-width="5%" data-align="center"
                        class="title">返佣利率
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getAdCategoryList';
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditAdCategoryPage?id=" + id;
            openNewWindow(url);
        });
