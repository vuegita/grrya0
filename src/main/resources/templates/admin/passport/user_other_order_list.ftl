            ...
            <div class="btn-group hidden-xs" id="bootstrapTableToolBar" role="group">
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="type" >
                        <option value="first_recharge_presentation" >首充赠送</option>
                        <option value="register_presentation" >注册赠送</option>
                        <option value="recharge_presentation_parentuser_by_percent" >充值返上级</option>
                    </select>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getPassportOtherOrderList';
