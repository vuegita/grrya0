...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getUserSystemFollowList';
        ...
        $(document).on('click', '#create-btn', function(){
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditSystemUserFollowPage";
            //window.location.href ='/alibaba888/Liv2sky3soLa93vEr62/toEditSystemUserFollowPage';
            openNewWindow(url);
        });
    ...
    function deleteFollow(username) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteUserSystemFollow',
            type: 'post',
            dataType: 'json',
