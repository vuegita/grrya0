...
<#--                    </th>-->
                    ...
                    <th data-field="settleMode" data-width="8%" data-align="center"
                        class="title">结算状态
                    </th>

                    <th data-field="showStatus" data-width="8%" data-align="center"
                        class="title">展示状态
                    </th>

                    <th data-field="limitRate1" data-width="5%" data-align="center"
                        class="title">首次扣款金额
                    </th>

                    <th data-field="limitStatus1" data-width="5%" data-align="center"
                        class="title">首次扣款状态
                    </th>

                    <th data-field="limitRate2" data-width="5%" data-align="center"
                        class="title">二次扣款比例
                    </th>

                    <th data-field="limitStatus2" data-width="5%" data-align="center"
                        class="title">二次扣款状态
                    </th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        ...
        result += '<a href="javascript:;" class="table-btn editInfo" data-no="' + row.no + '" title="编辑">编辑</a>';
    ...
    $(document).on('click', '.table-btn.editInfo', function () {
        ...
        var url = "/alibaba888/Liv2sky3soLa93vEr62/root_passport_promotion_present_order/edit/page?orderno=" + id;
        openNewWindow(url);
    });
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/root_passport_promotion_present_order/getDataList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/root_passport_promotion_present_order/edit/page';
            openNewWindow(url);
    ...
    function auditOrder(orderno, username, action) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/doAuditUserPromotionPresentOrder',
            type: 'post',
            dataType: 'json',
            data: {
                orderno: orderno,
