...
<#--                    <th data-field="type" data-width="5%" data-align="center" data-formatter="orderTypeFormatter"-->
<#--                        class="title">订单类型-->
<#--                    </th>-->

<#--                    <th data-field="businessName" data-width="5%" data-align="center" data-formatter="statusFormatter"-->
<#--                        class="title">业务类型-->
<#--                    </th>-->
...
<#--                    </th>-->
                    ...
                    <th data-field="remark" data-width="5%" data-align="center" data-formatter="columnFormatterForOrderRemarkMsg"
                        class="title">备注
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getUserRefundOrderRecordList';
