...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="sysOrderno" id="sysOrderno" class="form-control input-outline"  placeholder="请输入系统订单号" style="width:150px;">
                </div>
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="username" id="username" class="form-control input-outline"  placeholder="请输入代理用户名" style="width:150px;">
                </div>
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="vipType" data-width="5%" data-align="center"
                        class="title">类型
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getPassportBuyVipOrderList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toEditPassportUserVIPPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditPassportUserVIPPage?id=" + id;
            openNewWindow(url);
        });
