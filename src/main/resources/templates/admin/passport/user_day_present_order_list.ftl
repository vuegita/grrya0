            ...
            <div class="btn-group hidden-xs" id="bootstrapTableToolBar" role="group">
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="type" >
                        <option value="first_recarge_presentation" >首充赠送</option>
...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="businessKey" data-width="5%" data-align="center"
                        class="title">订单类型
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getPassportDayPresentOrderList';
