...
<#--                    </th>-->
                    ...
                    <th data-field="type" data-width="5%" data-align="center" data-formatter="typeactionFormatter"
                        class="title">所属分类
                    </th>

                    <th data-field="value" data-width="5%" data-align="center"
                        class="title">参数值
                    </th>

                    <th data-field="status" data-width="5%" data-align="center"   data-formatter="stakingStatusactionFormatter"
                        class="title">状态
                    </th>
...
<script type="text/javascript">
    ...
    function typeactionFormatter(value, row, index) {
        ...
        result += '';
        if(row.type == 'coin_defi_staking')
        {
            result += '质押';
        }else if(row.type == 'coin_defi_settle_withdraw'){
            result += '提现结算';
        }else{
            result += row.type;
        }
...
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getPassportAgentConfigList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toPassportAgentConfigInfoPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toPassportAgentConfigInfoPage?id=" + id;
            openNewWindow(url);
        });
