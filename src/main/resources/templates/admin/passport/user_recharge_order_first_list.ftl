...
<#--                        data-formatter="statusFormatter"-->
                    ...
                    <th data-field="parentname" data-width="10%" data-align="center"
                        class="title">父级上级
                    </th>

                    <th data-field="grantfathername" data-width="10%" data-align="center"
                        class="title">祖父级上级
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getFirstRechargeOrderList';
