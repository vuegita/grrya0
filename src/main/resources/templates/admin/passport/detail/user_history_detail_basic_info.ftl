                    ...
                    <#if report ? exists>
                        <table id="tabls" class="table table-striped table-bordered">
                            <tr >
                                ...
                                <td style="width: 330px;color: blue">${moneyInfo.codeAmount!} | 佣金=${moneyInfo.coldAmount!}</td>
                            </tr>
...
<#--                                -->
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title">我的下级当日汇总信息</h3>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <table id="tabls" class="table table-striped table-bordered">
                        <tr >
                            <th style="text-align:center;width: 250px">一级充值总额</th>
                            <td style="color: blue">${todaySubLevelStatsInfo.lv1RechargeAmount!}</td>
                            <th style="text-align:center;width: 250px">一级提现总额</th>
                            <td style="width: 330px;color: blue">${todaySubLevelStatsInfo.lv1WithdrawAmount!}</td>
                        </tr>

                        <tr >
                            <th style="text-align:center;width: 250px">二级充值总额</th>
                            <td style="color: blue">${todaySubLevelStatsInfo.lv2RechargeAmount!}</td>
                            <th style="text-align:center;width: 250px">二级提现总额</th>
                            <td style="width: 330px;color: blue">${todaySubLevelStatsInfo.lv2WithdrawAmount!}</td>
                        </tr>
