...
<#--                    </th>-->
                    ...
                    <th data-field="account" data-width="5%" data-align="center"
                        class="title">账户ID
                    </th>
                    <th data-field="ifsc" data-width="5%" data-align="center"
                        class="title">ifsc
                    </th>
                    <th data-field="beneficiaryName" data-width="5%" data-align="center"
                        class="title">受益人名称
                    </th>
                    <th data-field="beneficiaryEmail" data-width="5%" data-align="center"
                        class="title">受益人邮件
                    </th>
                    <th data-field="beneficiaryPhone" data-width="5%" data-align="center"
                        class="title">受益人手机
                    </th>
...
<#--                    </th>-->
                    ...
                    <th data-field="remark" data-width="10%" data-align="center"  data-formatter="remarkFormatter"
                        class="title">ID
                    </th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        ...
        result += '<a href="javascript:;" class="table-btn modifyBanCardInfo" data-no="' + row.id + '" title="编辑">编辑</a>';
        result += '<a href="javascript:;" class="table-btn deleteBanCardInfo" data-no="' + row.id + '" title="编辑">删除</a>';
        return result;
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getUserBankCardList';
        ...
        $(document).on('click', '.table-btn.modifyBanCardInfo', function () {
            var cardid = $(this).attr('data-no');

            window.location.href ='/alibaba888/Liv2sky3soLa93vEr62/toAddUserBankCardPage?cardid=' + cardid;
        });
    ...
    function deleteCardInfo(cardId) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteUserCardInfo',
            type: 'post',
            dataType: 'json',
            data:{
                cardid:cardId,
