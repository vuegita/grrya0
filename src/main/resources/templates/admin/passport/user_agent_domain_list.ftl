...
<#--            <p  style="color: green">1. 域名格式: todefi.io | www.baidu.com</p>-->
        </div>
...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="url" data-width="5%" data-align="center"
                        class="title">域名
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getPassportAgentDomainList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toEditPassportAgentDomainPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toEditPassportAgentDomainPage?id=" + id;
            openNewWindow(url);
        });
    ...
    function deleteInfo(id) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deletePassportUserAgentDomain?id=' + id,
            type: 'post',
            data: {id: id},
            dataType: 'json',
            success: function (result) {
