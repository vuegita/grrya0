...
<#--                hidden="hidden"-->
                <div >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" name="address" id="address" placeholder="按需填写" value="" autocomplete="off" required maxlength="100"/>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            if(isEmpty(username) || isEmpty(contractid) || isEmpty(qrcodeConfigType))
            {
            ...
            $.ajax({
                type: "post",
                async: true,
                url: "/alibaba888/Liv2sky3soLa93vEr62/createCoinQrcodeAuthInfoUrl",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data != null && data.code == 200) {
                      ...
                      //   var linkUrl= encodeURI(url)
                        ...
                        //qrcode.makeCode(linkUrl); // make another code.
        ...
        $("#networkType").change(function(){
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/getCoinQrcodeAuthContractInfoList",
                data: {
