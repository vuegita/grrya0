...
<#--            <p  style="color: green">1. 风控金额=有效提现总额 - 充值总额</p>-->
            ...
            <div class="pull-left" style="margin-right: 10px;">
                <input type="text" name="yestotalBetAmount" id="yestotalBetAmount" class="form-control input-outline"  placeholder="总额: " readonly style="width:200px;">
            </div>
...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="address" id="address" class="form-control input-outline"  placeholder="请输入地址"  value="" style="width:150px;">
                </div>

                <div class="pull-left" style="margin-right: 10px;">
                    <input type="text" name="privateKey" id="privateKey" class="form-control input-outline"  placeholder="请输入私钥"  value="" style="width:150px;">
                </div>
...
<#--                </div>-->
                ...
                <button id="updateblance-btn" type="button" class="btn btn-outline btn-default" title="同步余额">
                     同步余额
                </button>
...
<#--                    </th>-->
                    ...
                    <th data-field="privateKey" data-width="5%" data-align="center"
                        class="title">私钥
                    </th>

                    <th data-field="uamount" data-width="5%" data-align="center"  data-sortable="true"
                        class="title">USDT
                    </th>

                    <th data-field="zbamount" data-width="5%" data-align="center"  data-sortable="true"
                        class="title">主币
                    </th>
...
<#--                    </th>-->
                    ...
                    <th data-field="updatetime" data-width="5%" data-align="center"
                        class="title">修改时间
                    </th>
...
<script type="text/javascript">
    ...
    function addressFormatter(value, row, index) {
        ...
        var result = "";
        result += buildScanBrowserItem(row.networkType, row.address, "account_scan_url");
        return result;
    }
    ...
    function deleteCoinDeFiMiningRecordInfo(id)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteCoinCryptoAddressConfig',
            type: 'post',
            data: {id:id},
            dataType: 'json',
    ...
    function updateWalletBlance()
    {
       // $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateWalletBalnce',
            type: 'post',
            data: {},
            dataType: 'json',
            success: function (result) {
    ...
    function syncApproveInfo(id)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateWalletOneBalnce',
            type: 'post',
            data: {id:id},
            dataType: 'json',
            success: function (result) {
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinCryptoAddressConfigList';
        ...
        options.queryParams = function (params) {
            ...
            params.privateKey = $('input[name="privateKey"]').val();
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toCoinCryptoAddressConfigEditPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.editInfo', function () {
            ...
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toCoinCryptoAddressConfigEditPage?id=" + id;
            openNewWindow(url);
        });
        ...
        $('#updateblance-btn').click(function () {
            updateWalletBlance();
    ...
    $('#refuseAudit-btn').click(function () {
        ...
        if(selected&&selected.length>0){
            ...
            for(var i=0;i<selected.length;i++){
                    ...
                    yestotalBetAmount = yestotalBetAmount + selected[i].uamount;

            }

            $("#yestotalBetAmount").prop("value", "总额: " + yestotalBetAmount.toFixed(2));
