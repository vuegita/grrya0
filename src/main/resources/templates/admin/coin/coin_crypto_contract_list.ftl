...
<#--                    </th>-->
                    ...
                    <th data-field="address" data-width="15%" data-align="left"
                        data-formatter="contractInfoFormatter"
                        class="title">合约信息
                    </th>

                    <th data-field="currencyType" data-width="15%" data-align="left"
                        data-formatter="tokenInfoFormatter"
                        class="title">目标代币信息
                    </th>

<#--                    <th data-field="currencyCtrAddr" data-width="5%" data-align="center"-->
<#--                        class="title">代币地址-->
<#--                    </th>-->

<#--                    <th data-field="triggerAddress" data-width="5%" data-align="center"-->
<#--                        class="title">触发者地址-->
<#--                    </th>-->

<#--                    <th data-field="autoTransfer" data-width="5%" data-align="center"-->
<#--                        class="title">自动转账-->
<#--                    </th>-->

<#--                    <th data-field="minTransferAmount" data-width="5%" data-align="center"-->
<#--                        class="title">最低转账数量-->
<#--                    </th>-->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinCryptoContractList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toCoinCryptoContractEditPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toCoinCryptoContractEditPage?id=" + id;
            openNewWindow(url);
        });
    ...
    {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/batchCoinApproveContractList',
            type: 'get',
            dataType: 'json',
