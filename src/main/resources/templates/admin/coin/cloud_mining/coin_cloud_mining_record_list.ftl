...
<#--                    </th>-->
                    ...
                    <th data-field="days" data-width="5%" data-align="center"
                        class="title">投资期限
                    </th>

                    <th data-field="invesTotalAmount" data-width="5%" data-align="center"
                        class="title">投资金额
                    </th>
...
<script type="text/javascript">
    ...
    function detailInfoFormatter(value, row, index) {
        ...
        result += "所属 ID: " + row.id + " <br>";
        result += "所属用户: " + row.username + " <br>";
        // result += "所属网络: " + row.networkType + " <br>";
        // result += "挖矿币种: " + row.quoteCurrency + " <br>";
        result += "所属币种: " + row.currencyType + " <br>";
        result += "创建时间: " + row.createtime + " <br>";

        if(row.productType == "Coin_Cloud_Solid")
        {
            result += "挖矿类型: 质押挖矿 <br>";
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinCloudMiningRecordInfoList';
