...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="expectedRate" data-width="5%" data-align="center"
                        class="title">收益率
                    </th>
...
<#--                    </th>-->
                    ...
                    <th data-field="minWalletBalance" data-width="5%" data-align="center"
                        class="title">最低钱包金额
                    </th>

                    <th data-field="networkTypeSort" data-width="5%" data-align="center"
                        class="title">网络类型排序
                    </th>

                    <th data-field="quoteCurrencySort" data-width="5%" data-align="center"
                        class="title">挖矿币种排序
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinMiningProductInfoList';
    ...
    {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/batchCoinDeFiProductInfoList',
            type: 'get',
            dataType: 'json',
