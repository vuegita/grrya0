...
<script type="text/javascript">
    ...
    function userInfoFormatter(value, row, index) {
        ...
        try{
            ...
            if(jsonObj && jsonObj.stakingRate)
            {
                result += "结算利率: " + jsonObj.stakingRate + " <br>";
            }

            var voucherRewardAmount = 0;
            var balanceRewardAmount = row.amount;
            if(jsonObj && !isEmpty(jsonObj.voucherRewardAmount))
            {
                voucherRewardAmount = jsonObj.voucherRewardAmount;
                balanceRewardAmount = balanceRewardAmount - voucherRewardAmount;
                result += "代金收益: " + voucherRewardAmount + " <br>";
            }
            result += "本金收益: " + balanceRewardAmount + " <br>";
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinMiningOrderInfoList';
