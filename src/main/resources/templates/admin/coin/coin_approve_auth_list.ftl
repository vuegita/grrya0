...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        ...
        <#if isSuperAdmin == 'true'>
            result += '<a href="javascript:;" class="table-btn deleteApproveInfo" data-no="' + row.id + '" title="删除">删除</a>';
        </#if>
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinApproveAuthList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toEditAddCoinApprove';
            openNewWindow(url);
        });
    ...
    function syncApproveInfo(id)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/syncCoinApproveInfo',
            type: 'post',
            data: {id:id},
            dataType: 'json',
    ...
    function syncMiningInfo(id)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/syncMiningInfo',
            type: 'post',
            data: {id:id},
            dataType: 'json',
            success: function (result) {
    ...
    function deleteCoinApproveInfo(id)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteCoinApproveInfo',
            type: 'post',
            data: {id:id},
            dataType: 'json',
            success: function (result) {
    ...
    {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/batchCoinApproveSyncAll',
            type: 'get',
            dataType: 'json',
            success: function (result) {
                if (result.code === 200) {
