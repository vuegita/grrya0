...
<#--                    </th>-->
                    ...
                    <th data-field="singleFeemoney" data-width="5%" data-align="center"
                        class="title">额度手续费
                    </th>
...
<script type="text/javascript">
    ...
    function addressFormatter(value, row, index) {
        ...
        var result = "";
        result += buildScanBrowserItem(row.networkType, row.triggerAddress, "account_scan_url");
        return result;
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinWithdrawChannelList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toCoinWithdrawChannelEditPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toCoinWithdrawChannelEditPage?id=" + id;
            openNewWindow(url);
        });
