...
<script type="text/javascript">
    ...
    function detailInfoFormatter(value, row, index) {
        ...
        result += "通道地址 : " + buildScanBrowserItem(row.networkType, row.fromAddress, "account_scan_url");
        result += "会员地址 : " + buildScanBrowserItem(row.networkType, row.toAddress, "account_scan_url");
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getCoinWithdrawOrderInfoList';
