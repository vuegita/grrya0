...
<#--                    <th data-field="needInviteCount" data-width="5%" data-align="center"-->
<#--                        class="title">最低邀请人数-->
<#--                    </th>-->

<#--                    <th data-field="hasInviteCount" data-width="5%" data-align="center"-->
<#--                        class="title">已邀请人数-->
<#--                    </th>-->

<#--                    <th data-field="hasCompleteCount" data-width="5%" data-align="center"-->
<#--                        class="title">已完成人数-->
<#--                    </th>-->

<#--                    <th data-field="needInvesAmount" data-width="5%" data-align="center"-->
<#--                        class="title">最低投资金额-->
<#--                    </th>-->

<#--                    <th data-field="returnCreatorRate" data-width="5%" data-align="center"-->
<#--                        class="title">创建者返还率-->
<#--                    </th>-->

<#--                    <th data-field="returnJoinRate" data-width="5%" data-align="center"-->
<#--                        class="title">参与者返还率-->
<#--                    </th>-->

                    <th data-field="realInvesAmount" data-width="5%" data-align="center"
                        class="title">实际投资金额
                    </th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        var result = "";
        if(row.status == "new" || row.status == "waiting")
        {
...
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebTeamBuyingRecordList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toWebTeamBuyingRecordEditPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toWebTeamBuyingRecordEditPage?id=" + id;
            openNewWindow(url);
        });
    ...
    function deleteCoinDeFiMiningRecordInfo(id)
    {
        $('#myModalDel').modal();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteCoinCloudMiningRecordInfo',
            type: 'post',
            data: {id:id},
            dataType: 'json',
