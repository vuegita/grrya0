...
<#--                    </th>-->
                    ...
                    <th data-field="limitMinAmount" data-width="5%" data-align="center"
                        class="title">最低投资金额
                    </th>

                    <th data-field="limitBalanceAmount" data-width="5%" data-align="center"
                        class="title">至少需要余额
                    </th>

                    <th data-field="returnCreatorRate" data-width="5%" data-align="left"
                        class="title">创建者返回率
                    </th>
...
<#--        </#if>-->
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebTeamBuyingConfigList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toWebTeamBuyingConfigEditPage';
            openNewWindow(url);
        });

        $(document).on('click', '.table-btn.editInfo', function () {
            var id = $(this).attr('data-no');
            var url = "/alibaba888/Liv2sky3soLa93vEr62/toWebTeamBuyingConfigEditPage?id=" + id;
            openNewWindow(url);
        });
