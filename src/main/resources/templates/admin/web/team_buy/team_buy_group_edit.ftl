...
<#--                <div class="hr-line-dashed"></div>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" name="needInvesAmount" id="needInvesAmount" autocomplete="off"
                               required type="text" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'');"
                               value="<#if entity?exists> ${entity.needInvesAmount !} </#if>" />
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="radio i-checks">
                            <label>
                                <input type="radio"  name="status" id="status" value="new"
...
<script type="text/javascript">
    $(function () {
        ...
        $("#submitBtn").click(function () {
            ...
            var hasInviteCount = $('input[name="hasInviteCount"]').val();
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "/alibaba888/Liv2sky3soLa93vEr62/updateWebTeamBuyingGroupInfo",
                data: {
                    id:id.trim(),
                    hasInviteCount:hasInviteCount.trim(),
