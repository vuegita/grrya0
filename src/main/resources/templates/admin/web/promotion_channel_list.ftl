...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/root_web_promotion_channel/getDataList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/root_web_promotion_channel/edit/page';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            var url = '/alibaba888/Liv2sky3soLa93vEr62/root_web_promotion_channel/edit/page?id=' + memberid;
            openNewWindow(url);
        });
