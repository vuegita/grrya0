        ...
        <div class="ibox-content">
            <form id="form" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control" id="agentname" name="agentname" autocomplete="off" required maxlength="50" value="<#if agnetTips??>${agnetTips.agentname}</#if>" />
                    </div>
...
<#--                    </button>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="title" name="title" value="<#if agnetTips??>${agnetTips.title}</#if>" autocomplete="off" maxlength="255"
                               value=""/>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
...
<#--                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>内容:</label>-->
<#--                    <div class="col-sm-8" >-->
<#--                        <script id="container" name="content" type="text/plain" value="<#if agnetTips??>${agnetTips.content}</#if>">-->
<#--                        </script>-->
<#--                    </div>-->
<#--                </div>-->
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>内容:</label>
                    <div class="col-sm-6">
                        <textarea class="form-control"  rows="20" cols="20" id="container" name="container"  ><#if agnetTips??>${agnetTips.content}</#if></textarea>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#mysubmit').click(function () {
           ...
           //  var content = ue.getContent();
            ...
            if(isEmpty(agentname) || isEmpty(title) || isEmpty(content) ||  isEmpty(status)  ||  isEmpty(type))
            {
                $.global.openErrorMsg('* 号必填参数不能为空');
                return false;
            }
    ...
    function addData() {
       ...
       //  var content = ue.getContent();
        ...
        if(isEmpty(agentname) || isEmpty(title) || isEmpty(content) ||  isEmpty(status))
        {
            $.global.openErrorMsg('* 号必填参数不能为空');
            return false;
        }
        ...
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/editWebAgentTips',
            type: 'post',
            dataType: 'json',
            data:{
                id:id,
