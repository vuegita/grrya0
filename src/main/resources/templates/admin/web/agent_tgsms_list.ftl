...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="rbtoken" data-width="8%" data-align="center"
                        class="title">机器人token
                    </th>

                    <th data-field="chatid" data-width="8%" data-align="center"
                        class="title">TG群chatid
                    </th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebAgentTgsmsList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddWebAgentTgsmsPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddWebAgentTgsmsPage?id=' + memberid;
            openNewWindow(url);
        });
    ...
    function deleteCardInfo(memberid) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteAgentTgsms',
            type: 'post',
            dataType: 'json',
            data:{
                tipsid:memberid,
