...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        ...
        <div class="ibox-title">
            <p  style="color: green">跳转链接设置为 https://active.true 时点击出现登录时活动弹框</p>
            <p  style="color: green">跳转链接设置为 https://banner.true 时点击出现网站管理中的轮播弹出内容弹框</p>
            <p  style="color: green">打开视频跳转链接设置为 page=video&url=https://xxxxxxx</p>
        </div>
...
<#--                    </th>-->
                    ...
                    <th data-field="img" data-width="8%" data-align="center"  data-formatter="actionFormatterimg"
                        class="title">图片
                    </th>
                    <th data-field="webUrl" data-width="8%" data-align="center"
                        class="title">跳转地址
                    </th>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        ...
        result += '<a href="javascript:;" class="table-btn deleteBanner" data-no="' + row.id + '" title="删除">删除</a>';
        return result;
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebBannerList';
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddWebBannerPage?id=' + memberid;
            openNewWindow(url);
        });
