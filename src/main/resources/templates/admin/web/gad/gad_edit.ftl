    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form id="form" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2"><span class="text-danger">*&nbsp;</span>唯一ID:</label>
                    <div class="col-sm-3">
                        <input class="form-control" id="key" name="key" autocomplete="off" required maxlength="100" value="<#if entity??>${entity.key}</#if>" />
                    </div>
...
<#--                    </button>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="title" name="title" value="<#if entity??>${entity.title}</#if>" autocomplete="off" maxlength="255"
                               value=""/>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea class="form-control"  rows="20" cols="20" id="container" name="container"  ><#if entity??>${entity.content}</#if></textarea>
