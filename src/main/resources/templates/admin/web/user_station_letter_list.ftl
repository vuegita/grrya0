        ...
        <div class="ibox-content">
            <div class="btn-group hidden-xs" id="bootstrapTableToolBar" role="group">
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <button id="create-btn" type="button" class="btn btn-outline btn-default" title="发送信息">
                        <i class="glyphicon glyphicon-plus" aria-hidden="true"></i> 发送信息
                    </button>
                </div>
...
<#--                </div>-->
                ...
                <div class="pull-left" style="margin-right: 10px;">
                    <select class="form-control" name="txStatus" >
                        ...
                        <option value="waiting" >未阅读</option>
                        <option value="finish" >已阅读</option>
                    </select>
                </div>
...
<#--                </div>-->
            ...
            <table id="bootstrapTable">
                ...
                <tr>
                    ...
                    <th data-field="status" data-width="4%" data-align="center"  data-formatter="settleStatusFormatter"
                        class="title">信息状态
                    </th>
...
<script type="text/javascript">
    ...
    function settleStatusFormatter(value, row, index) {
        ...
        {
            result = "<Strong style='color: red'>未阅读</Strong>";
        }else if(row.status == 'finish'){
            result = "<Strong style='color: green'>已阅读</Strong>";
        }else{
            result=""+row.status;
        }
    ...
    function actionFormatter(value, row, index) {
        ...
        // agentid: 3
        // agentname: "agent01"
        // content: "是打发斯蒂芬士大夫士大夫士大夫收到发生的第三方第三方"
        // createtime: "2021-07-11 20:33:36"
        // id: 1
        // remark: ""
        // reply: "null"
        // staffid: 4
        ...
        if(row.status=="waiting"){
            result += '<a href="javascript:;" class="table-btn returnfeedback" data-no="' + row.id + '" title="回复">编辑</a>';
        }

        // if(row.status=="finish"){
        //     result += '<a href="javascript:;" class="table-btn returnfeedback" data-no="' + row.id + '" title="修改回复">编辑</a>';
        // }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getFeedBackList';
        ...
        options.queryParams = function (params) {
            ...
            params.type = "station_letter";//$('select[name="type"]').val();
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/addStationLetterPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.returnfeedback', function () {
            ...
            var url = '/alibaba888/Liv2sky3soLa93vEr62/addStationLetterPage?id=' + id;
            openNewWindow(url);
        });
