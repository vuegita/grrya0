...
<script type="text/javascript">
    ...
    $(document).on('click', '.table-btn.toAgentSettleOrderPage', function () {
        ...
        var url = '/alibaba888/Liv2sky3soLa93vEr62/root_web_settle_order?reportid=' + reportid ;
        // window.location.href = url;
        openNewWindow(url);
    });
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebSettleWithdrawReportList';
