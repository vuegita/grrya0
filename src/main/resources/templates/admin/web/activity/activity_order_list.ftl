...
<script type="text/javascript">
    ...
    function detailInfoFormatter(value, row, index) {
        ...
        result += "关联订单 : " + row.outTradeNo + "<br>";
        result += "订单类型 : " + row.businessType + "<br>";
        ...
        try {
            ...
            if(remark.extraPresentRate)
            {
                result += "基础赠送金额 : " + (row.amount - remark.extraPresentAmount) + "<br>";
                result += "额外赠送比例 : " + remark.extraPresentRate + "<br>";
                result += "额外赠送金额 : " + remark.extraPresentAmount + "<br>";
            }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebActivityOrderInfoList';
    ...
    function handleOrder(action, orderno)
    {
        $('#myModalDel').hide();
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/updateWebActivityOrderInfo',
            type: 'post',
            data: {
                action:action,
                orderno:orderno,
