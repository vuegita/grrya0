...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <p  style="color: green">2. 用户没有登录时显示的是所属员工为systemstaff01的客服</p>
        </div>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row, index) {
        ...
        result += '<a href="javascript:;" class="table-btn deleteMember" data-no="' + row.id + '" title="删除">删除</a>';
        return result;
    }
    ...
    $(function () {
        ...
        options.url = '/alibaba888/Liv2sky3soLa93vEr62/getWebStaffKefuList';
        ...
        $(document).on('click', '#create-btn', function () {
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddWebStaffKefuPage';
            openNewWindow(url);
        });
        ...
        $(document).on('click', '.table-btn.modifyMember', function () {
            ...
            debugger
            var url = '/alibaba888/Liv2sky3soLa93vEr62/toAddWebStaffKefuPage?id=' + memberid;
            openNewWindow(url);
        });
    ...
    function deleteCardInfo(id) {
        $.ajax({
            url: '/alibaba888/Liv2sky3soLa93vEr62/deleteWebStaffKefu',
            type: 'post',
            dataType: 'json',
            data:{
                id:id,
